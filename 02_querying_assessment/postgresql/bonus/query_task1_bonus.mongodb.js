...
//
// Your thinking:
// โจทย์ถามหา menu item ที่เป็น Side ทั้งหมด และเอาแค่ชื่อกับราคา
// ใช้ collection menu_items
// filter ด้วย category: 'Side' แล้วใช้ projection ซ่อน _id ออก เหลือแค่ name กับ price

...
-- โจทย์ถามหา menu item ที่เป็น Side ทั้งหมด เอาแค่ชื่อกับราคา
-- ใช้ SELECT เลือกแค่ name กับ price 
-- ดึงข้อมูลจาก table menuitems
-- แล้วกรองด้วย WHERE category = 'Side'

...
--
-- Your thinking:
-- โจทย์ถามหา staff ที่เป็น Cook ทั้งหมด เอาชื่อกับนามสกุล (ผมตั้งใจที่จะบวก role เพื่อเอาไว้ดูใน table ด้วย)
-- ใช้ SELECT เลือก first_name, last_name, role
-- ดึงข้อมูลจาก table staff
-- แล้วกรองด้วย WHERE role = 'Cook'
